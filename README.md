...
**Try the te reo Māori draft:** open Settings → Language → Te reo Māori in
version 30. Your choice stays on this device and works offline. **The translation
was generated by AI and may contain mistakes; it has not had fluent-speaker
review.** The installation guide now follows your language choice too. Some interface text
remains in English.
See the [translation status and review sheet](docs/LOCALIZATION.md).
...
The [version 30 preview release](https://github.com/reality2-ai/along/releases/tag/v0.30.0)
contains the ready-to-host ZIP and SHA-256 checksum. It is an experimental course
app with an unreviewed AI-generated Māori translation. The ZIP must be served
