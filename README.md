...
**Device testing:** use the regular **version 40** app above and follow the
[short S23/desktop guide](docs/DEVICE_CHECK.md). Physical pairing, TalkBack and
external-relay acceptance remain unverified. [Download version 40 to host yourself](https://github.com/reality2-ai/along/releases/tag/v0.40.0)
or read the [release evidence](docs/RELEASE_V40.md).
...
**For the current version 40 app, follow [Building Along](docs/BUILDING.md).**
...
server**; `npm start` does not reproduce version 40.
...
The [version 40 release](https://github.com/reality2-ai/along/releases/tag/v0.40.0)
contains `along-web-v40.zip` and its SHA-256 checksum. To host the current app,
...
[hosting](docs/HOSTING.md), and the [version 40 device check](docs/DEVICE_CHECK.md).
...
legacy planner in `dist/`; it does not include version 40's connected features.
