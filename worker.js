...
function database(){return new Promise((resolve,reject)=>{const req=indexedDB.open('along-offline',1);req.onupgradeneeded=()=>req.result.createObjectStore('timetable');req.onsuccess=()=>resolve(req.result);req.onerror=()=>reject(req.error);});}
