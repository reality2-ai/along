...
for (const name of ['enrollment-exchange.mjs', 'enrollment-protection.mjs', 'invitation.mjs']) sources.set('/' + name, await readFile(new URL(name, import.meta.url)));
...
try {
  ...
  console.log('PASS: actual browser crypto and core authorization reach candidate request and prepared persona; ownership transfer, ordering, decline, build/custody/expiry refusal, requested-key certificate binding and repeated OPEN checks hold. Synthetic initial trust and person consent; no durable installation claim.');
