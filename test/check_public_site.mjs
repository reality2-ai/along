...
try{
 ...
 console.log(JSON.stringify({url:base,appVersion:29,workerScope:scope,installability:true,settingsAboutLink:true,offlineNewAddressJourney:true,offlineInstallGuide:true,draftLanguageOffline:true,pageErrors:errors},null,2));
