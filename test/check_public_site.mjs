...
try{
 ...
 await page.locator('#settings-open').click();await expect(page.locator('#settings')).toContainText('App version 21');await expect(page.locator('#settings a[href="https://github.com/reality2-ai/along"]')).toBeVisible();await page.locator('#settings .close-dialog').click();
 ...
 console.log(JSON.stringify({url:base,appVersion:21,workerScope:scope,installability:true,settingsAboutLink:true,offlineNewAddressJourney:true,offlineInstallGuide:true,pageErrors:errors},null,2));
