...
try{
 ...
 console.log(JSON.stringify({url:base,appVersion:25,workerScope:scope,installability:true,settingsAboutLink:true,offlineNewAddressJourney:true,offlineInstallGuide:true,pageErrors:errors},null,2));
