...
expect(manifest.appVersion).toBe('46');
...
try{
 ...
 console.log('PASS: real static v46 offline Arrive by address/train/ferry/walk deadline; timing summary, ordering, learning departure hour and Leave now reset; open shortcut → options → removal, failed writes, retained results, keyboard/axe/narrow screen and offline reopening. No physical device or external relay.');
