"""Package qualified regular v39 payloads without altering the app's served files."""
import argparse
import hashlib
import json
...
REQUIRED = {'journeys','capacity_reporting','checkpoint_app','rotated_journeys',
            ...
            'older_edit_storage','installed_connected_upgrade','relay_membership_reconnect'}
...
def prepare(qualification):
    ...
    if (evidence.get('profile') != 'along-regular-candidate-qualification-v1'
            ...
            or evidence.get('app_version') != '39'
            or manifest.get('profile') != 'along-regular-upgrade-candidate-v1'
            or manifest.get('appVersion') != '39'
    ...
    output = ROOT / 'releases/along-web-v39'
    archive = ROOT / 'releases/along-web-v39.zip'
    ...
    with tempfile.TemporaryDirectory(dir=output.parent) as temporary:
        ...
        record = {'profile':'along-regular-release-v1','appVersion':'39','source_commit':evidence['source_commit'],
