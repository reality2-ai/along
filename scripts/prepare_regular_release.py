"""Package qualified regular v41 payloads without altering the app's served files."""
import argparse
import hashlib
import json
...
def prepare(qualification):
    ...
    if (evidence.get('profile') != 'along-regular-candidate-qualification-v1'
            ...
            or evidence.get('app_version') != '41'
            or manifest.get('profile') != 'along-regular-upgrade-candidate-v1'
            or manifest.get('appVersion') != '41'
    ...
    output = ROOT / 'releases/along-web-v41'
    archive = ROOT / 'releases/along-web-v41.zip'
    ...
    with tempfile.TemporaryDirectory(dir=output.parent) as temporary:
        ...
        record = {'profile':'along-regular-release-v1','appVersion':'41','source_commit':evidence['source_commit'],
