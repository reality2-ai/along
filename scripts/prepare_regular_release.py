"""Package qualified regular v44 payloads without altering the app's served files."""
import argparse
import hashlib
import json
...
REQUIRED = {'relay_origin_pacing','relay_enrollment_carriage','guided_scan','installed_v43_upgrade','guided_app_offline','guided_component','guided_cancel','guided_conflict',
...
def prepare(qualification):
    ...
    if (evidence.get('profile') != 'along-regular-candidate-qualification-v1'
            ...
            or evidence.get('app_version') != '44'
            or manifest.get('profile') != 'along-regular-upgrade-candidate-v1'
            or manifest.get('appVersion') != '44'
    ...
    output = ROOT / 'releases/along-web-v44'
    archive = ROOT / 'releases/along-web-v44.zip'
    ...
    with tempfile.TemporaryDirectory(dir=output.parent) as temporary:
        ...
        record = {'profile':'along-regular-release-v1','appVersion':'44','source_commit':evidence['source_commit'],
