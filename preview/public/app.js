...
import '../experiments/at-credentials/app-bootstrap.mjs';
...
try{if(localStorage.getItem('along-device-preview-course-notice-v1')==='understood')collapseCourseNotice();}catch{}
$('course-understood').onclick=()=>{
  try{localStorage.setItem('along-device-preview-course-notice-v1','understood');}catch{}
