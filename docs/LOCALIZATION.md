...
1. Complete the phrase catalogue for static markup, generated journey and stop
   ...
   screen-reader announcements. The current 216-phrase catalogue covers flow headings, common actions, place
   ...
   Remaining loading/update messages, nearby comparisons and guides are incomplete.
