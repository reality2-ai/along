...
1. Complete the phrase catalogue for static markup, generated journey and stop
   ...
   screen-reader announcements. The current 187-phrase catalogue covers flow headings, common actions, place
   ...
   also connected. Other status messages, Settings and guides remain incomplete.
