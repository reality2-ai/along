...
1. Complete the phrase catalogue for static markup, generated journey and stop
   ...
   screen-reader announcements. The current 252-phrase catalogue covers flow headings, common actions, place
   ...
   Remaining loading/update messages and guides are incomplete.
