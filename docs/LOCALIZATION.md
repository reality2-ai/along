...
1. Complete the phrase catalogue for static markup, generated journey and stop
   ...
   screen-reader announcements. The current 275-phrase catalogue covers flow headings, common actions, place
   ...
   Loading, offline readiness and storage summaries are now connected. App-update
   messages, untranslated worker errors, remaining static text and guides are
   incomplete. Raw errors retain explicit English metadata until migrated.
