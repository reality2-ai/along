...
Regular Along is version **38**. Device Preview **3806** is a separate installation.
For use or hosting, take the [v38 release ZIP and checksum](https://github.com/reality2-ai/along/releases/tag/v0.38.0).
...
| `scripts/build_upgrade_candidate.py --runtime …` | Current regular v38 candidate, including device groups, sharing and direct AT access |
| Published `along-web-v38.zip` | Qualified, immutable v38 distribution |
...
`643c6eebe4a748afca5ed6dc00d8b756dbbe8386`; later commits include packaging and
...
the verified v38 ZIP into `data/`. For a refreshed snapshot, follow the
...
Open `http://localhost:3082` and check version 38. Localhost permits service
