# Version 45 device check

Version 45 is published. The selected public hive still fails message forwarding;
...
and check **App version 45** in Settings on the S23 and desktop. Record both browser
...
An already-connected receiving device may show a conflict/recovery message.
Report it; keep its existing data. Do not create a replacement group.
