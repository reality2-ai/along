...
for (const name of ['../tg-pairing/initial-persona.mjs', '../tg-pairing/local-persona.mjs', 'local-owner.mjs', 'owner-policy.mjs', 'local-vault.mjs', 'delivery-ack.mjs', 'delivery-message.mjs', 'policy.mjs', 'policy-store.mjs']) sources.set('/' + name.split('/').pop(), await readFile(new URL(name, import.meta.url)));
