...
import {createEnrollmentLink} from './enrollment-link.mjs';
import {reserveInvitation} from './invitation-journal.mjs';
import {invitationStatement} from './invitation.mjs';

export async function createEnrollmentSession({wasm, invitation, role, store, candidateCeremony}) {
  ...
  try { link = createEnrollmentLink({wasm, invitation: expected, role, candidateCeremony}); }
