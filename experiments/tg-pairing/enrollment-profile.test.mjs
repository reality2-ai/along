...
const sources = new Map(await Promise.all(['enrollment-profile.mjs', 'enrollment-payloads.mjs'].map(async name => ['/' + name, await readFile(new URL('./' + name, import.meta.url))])));
